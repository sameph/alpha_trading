...
import { ArrowRight, Star, Shield, Clock, Award, Truck, Users, Globe, Package } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "15+ years of expertise in food commodity imports with 100% transparency"
    },
    {
      icon: Award,
      title: "Quality Assurance",
      description: "Rigorous quality control and certification of every shipment"
    },
    {
      icon: Clock,
      title: "Fast & Reliable",
      description: "Streamlined logistics ensuring your products arrive on time, every time"
    },
    {
      icon: Users,
      title: "Expert Support",
      description: "Dedicated team of specialists guiding you through every step"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                M.Y. ALPHA GENERAL TRADING delivers high-quality cooking oils, rice, and free zone services. 
                With 15+ years of expertise, we make food commodity imports seamless, transparent, and reliable.
              </p>
              ...
              <div className="flex items-center space-x-6">
                <div className="flex -space-x-2">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-10 h-10 bg-gradient-luxury rounded-full border-2 border-background flex items-center justify-center">
                      <Star className="w-4 h-4 text-luxury-foreground fill-current" />
                    </div>
                  ))}
                </div>
                <div>
                  <p className="text-sm font-semibold">Rated 5/5 by 2500+ clients</p>
                  <p className="text-xs text-muted-foreground">Excellence in every import</p>
                </div>
              </div>
            </div>
            ...
            <div className="animate-slide-up lg:animate-fade-in">
              <div className="relative">
                <img 
                  src={cookingOilImage} 
                  alt="Premium cooking oil products - M.Y. ALPHA quality imports"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl lg:text-5xl font-bold text-luxury mb-2">{stat.number}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-5xl font-bold mb-6">
              Why Choose <span className="text-luxury">M.Y. ALPHA</span>
            </h2>
            <p className="text-xl text-muted-foreground">
              Experience the difference of working with UAE's premier food import specialists
            </p>
          </div>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-luxury font-bold">{service.price}</span>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Discover our high-quality food commodities sourced from trusted global suppliers. 
                  From premium cooking oils to finest rice varieties, we ensure quality in every shipment.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-luxury mb-2">100+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="flex justify-center mb-6">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-8 h-8 text-luxury fill-current mx-1" />
              ))}
            </div>
            <blockquote className="text-3xl font-medium mb-8 text-foreground leading-relaxed">
              "M.Y. Alpha has been our trusted partner for food imports. Their quality assurance 
              and reliable delivery has helped our business grow significantly."
            </blockquote>
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                <cite className="text-luxury font-bold text-lg">Sarah Al-Zahra</cite>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-5xl font-bold mb-6">
              Ready to Start Your <span className="text-luxury">Import Journey?</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Join hundreds of satisfied clients who trusted us with their food commodity imports. 
