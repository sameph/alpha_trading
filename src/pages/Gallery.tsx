...
const Gallery = () => {
  ...
  const categories = ["All", "Sports Cars", "Luxury Sedans", "SUVs", "Classics", "Supercars"];
  ...
  const galleryItems = [
    {
      ...
      year: 2023,
      status: "Delivered",
      description: "Stunning M4 Competition delivered to satisfied client in Dubai"
    },
    {
      id: 2,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Explore our collection of successfully imported vehicles and see the quality 
              and variety that defines M.Y. ALPHA GENERAL TRADING.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-premium">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-8">
            ...
            <span className="text-luxury font-semibold">Filter by Category</span>
          </div>
            ...
            {filteredItems.map((item, index) => (
              ...
              >
                <div className="aspect-video bg-secondary relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-background/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="flex space-x-4">
                      <Button size="sm" variant="default" className="bg-gradient-luxury text-luxury-foreground">
                        <Eye className="w-4 h-4 mr-2" />
                        View
                      </Button>
                      <Button size="sm" variant="outline" className="border-border bg-background/90">
                ...
                <CardContent className="p-6">
                  <div className="mb-3">
                    <h3 className="text-xl font-bold text-luxury mb-1">{item.title}</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div 
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="text-4xl font-bold text-luxury mb-2">{stat.number}</div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                <h2 className="text-4xl font-bold mb-6">Featured Success Story</h2>
                <h3 className="text-2xl text-luxury font-semibold mb-4">
                  Ferrari F8 Tributo - A Dream Realized
                </h3>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  When Ahmed contacted us about importing a specific Ferrari F8 Tributo 
                  from Italy, we knew this wasn't just about a car purchase—it was about 
                  making a dream come true. After 3 months of careful sourcing, inspection, 
                  and seamless import process, we delivered this masterpiece to its new home.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-luxury rounded-full"></div>
                    <span className="text-sm">Source location: Maranello, Italy</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-luxury rounded-full"></div>
      ...
      <section className="py-20 bg-premium">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Want Your Car Featured Here?</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Let us help you import your dream vehicle and become part of our success story gallery.
            </p>
