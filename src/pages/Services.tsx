  ...
  const mainServices = [
    {
      ...
      features: ["Global sourcing", "Quality testing", "Bulk quantities", "Competitive pricing"],
      price: "Custom rates"
    },
    {
      icon: Wheat,
      ...
      features: ["Multiple varieties", "Quality grades", "Flexible packaging", "Fast delivery"],
      price: "Market rates"
    },
    {
      icon: FileText,
      ...
      features: ["Import licenses", "Customs clearance", "Quality certificates", "Legal compliance"],
    ...
    },
    {
      ...
      features: ["License processing", "Office setup", "Visa assistance", "Ongoing support"],
  ...
  return (
    <div className="min-h-screen bg-gradient-hero pt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              From sourcing to delivery, we handle every aspect of your food commodity imports 
              and free zone setup with precision, care, and expertise.
            </p>
          </div>
        </div>
      </section>
                ...
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-luxury font-semibold">{service.price}</p>
                    </div>
                  </div>
                  ...
                  <Button variant="default" className="w-full bg-gradient-luxury text-luxury-foreground hover:opacity-90">
                    Learn More
                  </Button>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              A streamlined 5-step process that ensures your commodity import is smooth and worry-free
            </p>
          </div>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-luxury rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl font-bold text-luxury-foreground">{step.step}</span>
                  </div>
              ...
              >
                <CardContent className="p-6">
                  ...
                  <Badge 
                    ...
                    className={service.included ? "bg-gradient-luxury text-luxury-foreground" : ""}
                  >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Complete free zone setup and management services. From license processing 
                  to ongoing operational support, we help you establish and maintain your 
              ...
              <div className="animate-slide-up">
                <div className="bg-gradient-card rounded-2xl p-8 border border-border shadow-luxury">
                  <h3 className="text-2xl font-bold mb-6 text-center">Popular Free Zones</h3>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in">
              ...
              <blockquote className="text-2xl font-medium mb-6 text-foreground">
                "M.Y. Alpha made our food import business incredibly smooth. Their expertise 
                in sourcing quality products and handling all documentation exceeded our expectations."
              </blockquote>
              <cite className="text-luxury font-semibold">- Omar Al-Rashid, Food Distribution LLC</cite>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-premium">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Ready to Start Your Import Business?</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Get started with a free consultation and discover how easy importing can be.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="default" className="bg-gradient-luxury text-luxury-foreground hover:opacity-90 px-8 py-3">
                Start Your Import
              </Button>
              <Button variant="outline" className="border-border hover:bg-secondary px-8 py-3">
