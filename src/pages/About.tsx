        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-5xl font-bold mb-6">
              About <span className="text-luxury">Alpha G.T FZCO</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Your trusted partner in luxury automotive imports since 2008. We
              specialize in bringing the world's finest vehicles to your
              doorstep with unmatched expertise and service.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Founded in 2008, Alpha G.T FZCO GENERAL TRADING began with a
                  simple vision: to make luxury automotive imports accessible,
                  transparent, and reliable. What started as a small operation
                  has grown into one of the region's most trusted car import
                  specialists.
                </p>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  We understand that importing a vehicle is more than just a
                  transaction—it's about bringing dreams to life. Every car we
                  import undergoes rigorous quality checks and documentation
                  processes to ensure you receive nothing but the best.
                </p>
                <Button
                  variant="default"
                ...
                <Card className="bg-gradient-card border-border shadow-premium">
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground mb-6">
                      To provide exceptional automotive import services that
                      exceed expectations while maintaining the highest
                      standards of quality, transparency, and customer
                      satisfaction.
                    </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Our experienced professionals ensure every import meets the
              highest standards
            </p>
          </div>
