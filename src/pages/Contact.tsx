...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone Numbers",
      details: ["+971 4 XXX XXXX", "+971 50 XXX XXXX", "24/7 Support Available"]
    },
    {
      icon: Mail,
      title: "Email Address",
      details: ["info@myalpha-trading.com", "imports@myalpha-trading.com", "Quick Response Guaranteed"]
    },
    {
      icon: Clock,
      title: "Business Hours",
      details: ["Sunday - Thursday: 9AM - 6PM", "Friday: 2PM - 6PM", "Saturday: 10AM - 4PM"]
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Ready to import your dream car? Contact our expert team for personalized 
              consultation and start your import journey today.
            </p>
          </div>
        </div>
      </section>
            ...
            {offices.map((office, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-luxury font-semibold mb-2">{office.type}</p>
                  <p className="text-sm text-muted-foreground mb-3">{office.address}</p>
                  <p className="text-sm font-mono text-foreground">{office.phone}</p>
                </CardContent>
              </Card>
            ))}
          </div>
            ...
            {[
              {
                ...
                answer: "Typically 4-8 weeks depending on the source country and vehicle specifications."
              },
              {
                question: "What documents do I need?",
                answer: "Valid Emirates ID, passport copy, and proof of residence. We handle all other paperwork."
              },
              {
                question: "Do you provide financing options?",
                answer: "Yes, we work with leading banks to offer competitive financing solutions."
              },
              {
                question: "Is there a warranty on imported vehicles?",
                answer: "We offer comprehensive inspection and can arrange extended warranty options."
              }
            ].map((faq, index) => (
              <Card 
                key={index}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Ready to Start Your Import?</h2>
            <p className="text-xl text-muted-foreground mb-8">
